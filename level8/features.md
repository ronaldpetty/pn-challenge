...
- Enterprise registry model: enterprise registries join their home index with signed registry address credentials.
...
- Distributed/federated index: two indexes and peer traversal exist, but there is no sharding, consensus, replication, or cross-index trust policy.
