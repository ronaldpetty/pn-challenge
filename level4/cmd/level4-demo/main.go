...
import (
	...
	"github.com/ronaldpetty/pn-challenge/level4/internal/app"
)
...
func run(args []string) error {
	if len(args) < 2 {
		return fmt.Errorf("usage: %s <artifacts|index|registry|private-facts|mcp|rotator|consumer|swimlane|health>", args[0])
	}
